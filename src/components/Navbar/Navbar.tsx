  ...
  return (
    <nav className={styles.navbar}>
      ...
      <div className={styles.links}>
        <a href={`${ANGULAR_BASE}/dashboard`} className={clsx(styles.link, styles.external)} title={t.nav.externalTooltip}>
        ...
        <a href={`${ANGULAR_BASE}/tasks`} className={clsx(styles.link, styles.external)} title={t.nav.externalTooltip}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className={styles.right}>
        <span className={styles.statChip}>
          ...
          {stats.completionRate}% {t.status.done.toLowerCase()}
        </span>
        {stats.overdue > 0 && (
